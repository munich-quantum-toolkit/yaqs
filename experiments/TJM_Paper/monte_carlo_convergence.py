...
def run_monte_carlo_convergence() -> None:
    ...
    filename = "results/monte_carlo_convergence/TJM_Convergence_order2_dt01.pickle"
    ...
    simulator.run(state, H_0, sim_params, noise_model)
    filename = "results/monte_carlo_convergence/TJM_Convergence_order2_dt02.pickle"
    with open(filename, "wb") as f:
        pickle.dump(
            {
                "sim_params": sim_params,
    ...
    simulator.run(state, H_0, sim_params, noise_model)
    filename = "results/monte_carlo_convergence/TJM_Convergence_order2_dt05.pickle"
    with open(filename, "wb") as f:
        pickle.dump(
            {
                "sim_params": sim_params,
    ...
    simulator.run(state, H_0, sim_params, noise_model)
    filename = "results/monte_carlo_convergence/TJM_Convergence_order1_dt01.pickle"
    with open(filename, "wb") as f:
        pickle.dump(
            {
                "sim_params": sim_params,
    ...
    simulator.run(state, H_0, sim_params, noise_model)
    filename = "results/monte_carlo_convergence/TJM_Convergence_order1_dt02.pickle"
    with open(filename, "wb") as f:
        pickle.dump(
            {
                "sim_params": sim_params,
    ...
    simulator.run(state, H_0, sim_params, noise_model)
    filename = "results/monte_carlo_convergence/TJM_Convergence_order1_dt05.pickle"
    with open(filename, "wb") as f:
        pickle.dump(
            {
                "sim_params": sim_params,
    ...
    filename = "results/monte_carlo_convergence/QuTip_exact_convergence.pickle"
    with open(filename, "wb") as f:
        pickle.dump(
            {
                "sim_params": sim_params,
