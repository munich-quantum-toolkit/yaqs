...
if __name__ == "__main__":
    ...
    filename = f"TJM_Convergence_order2_dt01.pickle"
    ...
    sim_params = PhysicsSimParams(measurements, T, dt, N, max_bond_dim, threshold, order, sample_timesteps=sample_timesteps)
    simulator.run(state, H_0, sim_params, noise_model)
    filename = f"TJM_Convergence_order2_dt02.pickle"
    with open(filename, 'wb') as f:
        pickle.dump({
            'sim_params': sim_params,
        }, f)
    ...
    sim_params = PhysicsSimParams(measurements, T, dt, N, max_bond_dim, threshold, order, sample_timesteps=sample_timesteps)
    simulator.run(state, H_0, sim_params, noise_model)
    filename = f"TJM_Convergence_order2_dt05.pickle"
    with open(filename, 'wb') as f:
        pickle.dump({
            'sim_params': sim_params,
        }, f)
    ...
    sim_params = PhysicsSimParams(measurements, T, dt, N, max_bond_dim, threshold, order, sample_timesteps=sample_timesteps)
    simulator.run(state, H_0, sim_params, noise_model)
    filename = f"TJM_Convergence_order1_dt01.pickle"
    with open(filename, 'wb') as f:
        pickle.dump({
            'sim_params': sim_params,
        }, f)
    ...
    sim_params = PhysicsSimParams(measurements, T, dt, N, max_bond_dim, threshold, order, sample_timesteps=sample_timesteps)
    simulator.run(state, H_0, sim_params, noise_model)
    filename = f"TJM_Convergence_order1_dt02.pickle"
    with open(filename, 'wb') as f:
        pickle.dump({
            'sim_params': sim_params,
        }, f)
    ...
    sim_params = PhysicsSimParams(measurements, T, dt, N, max_bond_dim, threshold, order, sample_timesteps=sample_timesteps)
    simulator.run(state, H_0, sim_params, noise_model)
    filename = f"TJM_Convergence_order1_dt05.pickle"
    with open(filename, 'wb') as f:
        pickle.dump({
            'sim_params': sim_params,
        }, f)
