...
def run_bond_dimension_convergence() -> None:
    ...
    filename = "results/bond_dimension/convergence/TJM_Convergence_Bond4.pickle"
    ...
    simulator.run(state, H_0, sim_params, noise_model)
    filename = "results/bond_dimension/convergence/TJM_Convergence_Bond8.pickle"
    with open(filename, "wb") as f:
        pickle.dump(
            {
                "sim_params": sim_params,
    ...
    simulator.run(state, H_0, sim_params, noise_model)
    filename = "results/bond_dimension/convergence/TJM_Convergence_Bond16.pickle"
    with open(filename, "wb") as f:
        pickle.dump(
            {
                "sim_params": sim_params,
    ...
    filename = "results/bond_dimension_convergence/QuTip_exact_convergence.pickle"
    with open(filename, "wb") as f:
        pickle.dump(
            {
                "sim_params": sim_params,
