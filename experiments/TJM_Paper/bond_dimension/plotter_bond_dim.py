...
# im = axes[2, 0].imshow(np.abs(heatmap_exact-heatmap1000), cmap=cmap, aspect='auto', extent=[0, data['sim_params'].elapsed_time, L, 0], norm=norm)
...
im = axes[0, 0].imshow(error_heatmap, cmap=cmap, aspect='auto', extent=[0, data['sim_params'].elapsed_time, L, 0], norm=norm)
...
error_heatmap = np.array(error_heatmap)
error_heatmap = np.mean(error_heatmap, axis=0)
im = axes[1, 0].imshow(error_heatmap, cmap=cmap, aspect='auto', extent=[0, data['sim_params'].elapsed_time, L, 0], norm=norm)
...
heatmap1000 = np.array(heatmap1000)
heatmap_exact = np.array(heatmap_exact)
# im = axes[2, 1].imshow(np.abs(heatmap_exact-heatmap1000), cmap=cmap, aspect='auto', extent=[0, data['sim_params'].elapsed_time, L, 0], norm=norm)
...
error_heatmap = np.array(error_heatmap)
error_heatmap = np.mean(error_heatmap, axis=0)
im = axes[0, 1].imshow(error_heatmap, cmap=cmap, aspect='auto', extent=[0, data['sim_params'].elapsed_time, L, 0], norm=norm)
...
error_heatmap = np.array(error_heatmap)
error_heatmap = np.mean(error_heatmap, axis=0)
im = axes[1, 1].imshow(error_heatmap, cmap=cmap, aspect='auto', extent=[0, data['sim_params'].elapsed_time, L, 0], norm=norm)
