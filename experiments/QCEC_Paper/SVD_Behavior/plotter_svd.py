...
def combine_trajectories(dir):
    ...
    for filename in os.listdir(dir):
        ...
        data.extend(trajectory["expectation_values"] for trajectory in batch["trajectories"])
...
def plot_with_variance(ax, filepath, label, line_style="-", alpha_fill=0.2) -> None:
    ...
    ax.fill_between(thresholds, avg_errs - std_errs, avg_errs + std_errs, alpha=alpha_fill)
