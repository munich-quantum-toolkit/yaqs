...
Thank you for your interest in contributing to MQT YAQS! This document outlines
the development guidelines and how to contribute.

We use GitHub to [host code](https://github.com/munich-quantum-toolkit/yaqs), to
...
When it is time to release a new version of MQT YAQS, create a PR that prepares
...
a breaking change for MQT YAQS. If you are sure that the dependency update does
not introduce any breaking changes for MQT YAQS, you can remove the
