...
[pull requests](https://github.com/munich-quantum-toolkit/yaqs/pulls).
...
- 🐛 Report bugs:
  ...
  <https://github.com/munich-quantum-toolkit/yaqs/issues>.
...
MQT YAQS adheres to [Semantic Versioning],
...
Use it to explain how users may need to adapt their usage of MQT YAQS,
...
When it is time to release a new version of MQT YAQS,
...
changes for MQT YAQS, you can remove the {code}`minor` or {code}`major`
label from the PR.
