...
| `runtime_cost`                           | MPS-backed analog and digital runs with observables (contraction-cost heuristic over time).                                                                           |
| `max_bond`                               | MPS-backed analog and digital runs with observables (maximum bond dimension over time).                                                                               |
| `total_bond`                             | MPS-backed analog and digital runs with observables (sum of internal bond dimensions).                                                                                |
