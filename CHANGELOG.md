...
- updated memory characterization backend ([#598])
  ([**@aaronleesander**])
- raised minimum Qiskit version from 1.1.0 to 2.1.0 ([#597]) ([**@denialhaag**])
...
- fixed inconsistent site ordering across dense, sparse, and MPO representations ([#600])
  ([**@aaronleesander**])
