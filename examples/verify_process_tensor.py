...
def create_memory_system_mpo():
    ...
    mpo = MPO()
    mpo.from_pauli_sum(terms=[(1.0, "X0 X1"), (1.0, "Y0 Y1"), (1.0, "Z0 Z1")], length=2, physical_dimension=2)
    return mpo


def verify_process_tensor() -> None:
    ...
    pt = run(mpo, sim_params, timesteps, num_trajectories=100)
